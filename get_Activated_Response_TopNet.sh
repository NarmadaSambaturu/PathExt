...
python activated_response_Pijs.py ${data_fname} ${perturbation_sample} ${control_sample} ${unweighted_nw_fname} ${percentile} ${path_length_thresh} ${num_trials} ${out_dir}/${response_nw_fname} ${out_dir}/temp/Pij
